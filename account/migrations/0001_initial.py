# Generated by Django 3.1.7 on 2023-02-02 05:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ra_1080', models.BooleanField(verbose_name='ra 1080')),
                ('ra_9258', models.BooleanField(verbose_name='ra_9258')),
                ('csc_prof', models.BooleanField(verbose_name='csc prof')),
                ('csc_sub_prof', models.BooleanField(verbose_name='csc sub prof')),
                ('pd_907', models.BooleanField(verbose_name='pd 907')),
                ('tesda', models.BooleanField(verbose_name='tesda')),
                ('length_of_service', models.DateField(verbose_name='date hired')),
                ('date_hired', models.DateField(verbose_name='length of Service')),
