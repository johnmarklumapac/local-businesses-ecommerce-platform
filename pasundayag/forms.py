...
from . models import Personnel, Function, Subfunction, PersonnelFunctionIPCR, PersonnelSubfunctionIPCR
from django.forms import modelformset_factory

FunctionFormSet = modelformset_factory(PersonnelFunctionIPCR, fields=('accomplishments', 'rating_Q', 'rating_E', 'rating_T', 'remarks'))

SubfunctionFormSet = modelformset_factory(PersonnelSubfunctionIPCR, fields=('accomplishments', 'rating_Q', 'rating_E', 'rating_T', 'remarks'))
...
class PersonnelIPCRForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('personnel', 'year', 'period', 'function', 'subfunction', 'accomplishments', 'rating_Q', 'rating_E', 'rating_T', 'remarks')
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['personnel'].choices = [(None, "Please select personnel to rate...")] + list(self.fields['personnel'].choices)[1:]
