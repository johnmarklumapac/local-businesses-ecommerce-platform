...
class Rank(MPTTModel):
    ...
    def has_daughter_rank(self):
        return Rank.objects.filter(parent=self).exists()
...
class IPCR(models.Model):
    ...
    def calculate_final_numerical_rating(self):
        self.calculate_stra_total()
        self.calculate_core_acad_total()
        self.calculate_core_prod_total()
        self.calculate_core_tech_total()
        self.calculate_supp_total()
    ...
    def rank_save(self, *args, **kwargs):
        self.rank = self.personnel.rank
        super().save(*args, **kwargs)

    def save(self, *args, **kwargs):
        self.calculate_final_numerical_rating
